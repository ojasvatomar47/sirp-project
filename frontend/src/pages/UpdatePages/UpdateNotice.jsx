...
const UpdateNotice = () => {
    ...
    return (
        <div className='flex justify-center items-center font-lora'>
            <div className={
                "bg-gradient-to-tl from-teal-200 to-[#fff3f3] p-4 sm:p-6 md:p-8 lg:p-10 border-[3px] border-t-teal-600 border-l-teal-600" +
                ...
                <form onSubmit={handleUpdate}>
                    ...
                    <div className="mb-4 sm:mb-4 md:mb-5 lg:mb-6">
                        ...
                        <textarea
                            ...
                            placeholder="Provide Updated Description to Your Notice"
